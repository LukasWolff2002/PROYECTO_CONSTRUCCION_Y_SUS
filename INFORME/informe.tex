...
\fancyhead[L]{\raisebox{0.20cm}{\textbf{Construcción y sustentabilidad en hormigón Armado}}} % Añade el texto en la parte izquierda del encabezado, subiéndolo ligeramente
...
%----------------------------------------------------------------------------------------
\HRule \\[0.4cm]
{ \huge \bfseries Proyecto Final}\\[0.4cm] % Titulo del documento
{ \huge \bfseries Construcción y Sustentabilidad en Hormigón Armado}\\[0.4cm] % Titulo del documento
\HRule \\[1.5cm]
 \vspace{5cm}
%----------------------------------------------------------------------------------------
%	SECCION DEL AUTOR
...
\newpage
%----------------------------------------------------------------------------------------
\include{secciones_inf/01intro.tex}
\newpage
\include{secciones_inf/02proceso_constructivo.tex}
\newpage
\include{secciones_inf/03hormigones.tex}
\newpage
\include{secciones_inf/04problemas_calidad.tex}
\newpage
\include{secciones_inf/05MMC.tex}
\newpage
\include{secciones_inf/06conclu.tex}

\newpage
\bibliographystyle{plain} % Estilo de la cita (puedes usar 'ieeetr', 'apalike', etc.)
\bibliography{biblio.bib} % Nombre de tu archivo .bib 
