...
Los módulos se fabricarían en planta en ambiente controlado, en la modalidad de elemento terminado con estructura, aislación, revestimientos, instalaciones, puertas y ventanas ya integrados. Luego se transportan y montan con grúa sobre la losa de fundación de hormigón armado descrita en la Sección~\ref{sec:campamento}, que actúa como la única interfaz ejecutada in situ. Para alcanzar su máximo valor, la integración debe darse desde las etapas tempranas del proyecto mediante los habilitadores de la CI: el diseño para manufactura y montaje (DfMA), la metodología BIM para coordinar anticipadamente las instalaciones con la disposición de módulos, y la filosofía Lean para eliminar pérdidas en el flujo de trabajo \cite{GuiaMMC}.
